...
function acf_blocks() {
    if ( function_exists( 'acf_register_block_type' ) ) {
        ...
        acf_register_block_type(
            array(
                'name'            => 'cb_seasonal_package_banner',
                'title'           => __( 'CB Seasonal Package Banner' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/cb-seasonal-package-banner.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                ...
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/lc-price-list.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'lc_seasonal_gallery',
                'title'           => __( 'LC Seasonal Gallery' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/lc-seasonal-gallery.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'lc_text_gallery',
                'title'           => __( 'LC Text Gallery' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/lc-text-gallery.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                'name'            => 'lc_image_cards',
                'title'           => __( 'LC Image Cards' ),
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/lc-image-cards.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
        ...
        acf_register_block_type(
            array(
                ...
                'category'        => 'layout',
                'icon'            => 'cover-image',
                'render_template' => 'blocks/lc-full-width-text.php',
                'mode'            => 'edit',
                'supports'        => array(
                    'mode'      => false,
                    'anchor'    => true,
